...
export class MortgageDetailPage {
  ...
  prepareData() {
    ...
    this.items.push({ label: '按揭银行', value: this.mortgage.ajbankname });
    ...
    this.items.push({ label: '异常类型', value: this.mortgage.abnormalname });
    this.items.push({ label: '异常说明', value: this.mortgage.frontdesc });
